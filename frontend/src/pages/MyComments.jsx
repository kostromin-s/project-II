...
const MyComments = () => {
  const { token, comments, replies, getComments, getRepliesByUser } =
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  />
                  <div>
                    <p className="text-sm text-gray-500">Bạn đã bình luận về</p>
                    <p className="text-sm font-medium text-gray-700">
                      {comment.productData.name}
                    </p>
                  </div>
                </div>

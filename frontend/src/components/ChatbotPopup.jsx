...
export default function ChatbotPopup() {
  const { messages, addMessages, getMessages, clearMessages, token } =
  ...
  const handlelogintochat = () => {
    toast.warn(
      "Đăng nhập hoặc đăng ký để trò chuyện với trợ lý AI của chúng tôi!"
    );
    navigate("/login");
  };
        ...
        {open && (
          ...
          >
            ...
            <div className="bg-blue-600 text-white p-3 flex justify-between items-center">
              <h2 className="font-semibold text-sm">Trò chuyện với bot</h2>

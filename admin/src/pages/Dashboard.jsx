...
const Dashboard = () => {
  ...
  const chartData = dashData
    ? [
        { name: "Sản phẩm", value: dashData.qproducts },
        { name: "Giỏ hàng", value: dashData.qcarts },
        { name: "Bình luận", value: dashData.qcomments },
      ]
    : [];

  const pieColors = ["#4f46e5", "#16a34a", "#f59e0b"]; // Tùy chỉnh màu sắc
    ...
    dashData && (
      <div className="m-5">
        ...
        <div className="bg-white p-4 rounded border-2 border-gray-100 mb-5 w-full">
          <h2 className="text-lg font-semibold mb-4">Tổng quan thống kê</h2>
        ...
        {/* Biểu đồ tròn */}
        <div className="bg-white p-4 rounded border-2 border-gray-100 mb-5 w-full">
          <h2 className="text-lg font-semibold mb-4">Tỉ lệ phân bố</h2>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={chartData}
        ...
        <div className="bg-white">
          <div className="flex items-center gap-2.5 px-4 py-4 mt-4 rounded-t border">
            <img src="" alt="" />
            <p className="font-medium text-lg">Người dùng mới nhất</p>
          </div>
          <div>

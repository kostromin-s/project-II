...
const Comments = () => {
  ...
  return (
    <div className="w-full max-w-6xl m-4 sm:m-8">
      <p className="mb-4 text-lg font-semibold">Tất cả bình luận</p>
          ...
          >
            ...
            <div className="text-sm">
              ...
              <p className="block sm:hidden text-gray-600">
                <span className="font-medium">{comment.userData.name}:</span>{" "}
                {comment.text}
              </p>
            </div>
            ...
            {commentWithRepliesShown?._id === comment._id && (
              <div className="col-span-full mt-3 space-y-3">
                {filteredReplies(comment._id).length > 0 ? (
                  ...
                  <p className="text-gray-500 text-sm">Chưa có phản hồi nào.</p>
                )}
              </div>
            )}
          </div>
